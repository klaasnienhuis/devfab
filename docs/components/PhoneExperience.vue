...
<template>
  <v-responsive :aspect-ratio="4 / 3" class="w-100">
    ...
    ></iframe>
    <div
      class="w-full h-10 md:h-16 absolute bottom-0 flex justify-center content-center space-x-3"
    >
          ...
          >
            ...
            >
              <span
                ...
                :class="[
                  color.bgColor,
                  'h-4 w-4 md:h-6 md:w-6 rounded-full border border-black border-opacity-10',
                ]"
              />
            </div>
          </RadioGroupOption>
